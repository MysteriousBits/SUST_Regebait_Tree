...
\codeWithDescription{Line Distance}{geometry/lineDistance.h}
[Returns the signed perpendicular distance from point $p$ to the line through points $a$ and $b$. The distance is positive if $p$ is to the left of the line $a \rightarrow b$, and negative otherwise.]
[graphics/geometry/lineDistance]
...
\code{Circumcircle}{geometry/circumcircle.h}
